<template>
  <div class="appbar">
    ...
    <HomePageAppBarToolBar @open:flex="openFlex" @open:grid="openGrid" />
  </div>
  <div class="container">
    <div class="container__content">
      <n-tabs type="segment" class="tabs__container" pane-class="tab-pane-container">
        <n-tab-pane name="book">
          <template #tab>
            <HomePageTabListItem>
              <template #icon>
          ...
          <HomePageBookOverViewGridLayOut v-if="isGridOpen" />
          <HomePageBookOverViewFlexLayOut v-if="isFlexOpen" />
        </n-tab-pane>
        <n-tab-pane name="photo">
          <template #tab>
            <HomePageTabListItem>
              <template #icon>
                <i-clarity-image-gallery-line />
              </template>
              <template #text>
                画册
              </template>
        ...
        <n-tab-pane name="newspaper">
          <template #tab>
            <HomePageTabListItem>
              <template #icon>
                <i-icomoon-free-newspaper />
              </template>
              <template #text>
                期刊杂志
              </template>
